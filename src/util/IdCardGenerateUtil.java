...
public class IdCardGenerateUtil
{
	static final int cities = 999999;
	...
	private static final int[] calcC =
	{ 7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2 };
	private static final char[] calcR =
	...
	{
		String operatorPrefix = "epay_xjf_";
		for (int i = 1; i <= 10; i++) {
			String operatorId = operatorPrefix + String.format("%06d", i) + "@163.com";
